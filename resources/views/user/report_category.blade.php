                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form id="fileUploadForm" method="POST" action="{{ url('/upload_report') }}"
            ...
            <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <h6 class="page-title">Report - {{$report_catgoires[0]['name']}}</h6>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a style="letter-spaceing:2px"
                                                    href="{{route('user.pdf',$item->DocumentNumber)}}"><i
                                                        class="fas fa-eye    "></i>
                                                    View Report</a>
                                            </td>
                                        </tr>
